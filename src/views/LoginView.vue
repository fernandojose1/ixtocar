...
import { UserIcon, KeyIcon, TruckIcon } from "@heroicons/vue/24/outline";
</script>
...
<template>
  <div class="container">
    ...
    <div class="right_container">
      <div class="logo_area">
        <div class="circle"><TruckIcon class="sizeLogo"/></div>
        <h2 class="logo">Ixtocar</h2>
      </div>
      ...
      <span class="span_login">
        Não possui cadastro?
        <router-Link :to="{ name: 'createUser' }">Crie sua conta</router-Link>
      </span>
    </div>
    <footer class="footer_login">
      Copyright @ 2022 - Desenvolvido por Fernando josé e Renato Vieira
    </footer>
  </div>
</template>
...
.input_field input::placeholder {
  font-size: 15px;
  color: 5px 5px 15px rgba(175, 175, 175, 0.5);
}
